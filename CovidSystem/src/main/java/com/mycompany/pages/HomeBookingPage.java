...
/**
 * This class represents the home booking page
 */
public class HomeBookingPage extends javax.swing.JPanel {
    ...
    private String generatedUrl = "https://www.youtube.com/watch?v=w9kzUqWKMPE";
    private static final ControlPanel controlPanel = ControlPanel.getControlPanel();
    public static final int DAYS_IN_ADVANCE = 5; 
    ...
    /**
     * Creates new form HomeBookingPage
     */
    ...
    private void initComponents() {
        ...
        homeBookingConfirmPanel = new javax.swing.JPanel();
        ...
        homeBookingConfirmPanel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        javax.swing.GroupLayout homeBookingConfirmPanelLayout = new javax.swing.GroupLayout(homeBookingConfirmPanel);
        homeBookingConfirmPanel.setLayout(homeBookingConfirmPanelLayout);
        homeBookingConfirmPanelLayout.setHorizontalGroup(
            homeBookingConfirmPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(homeBookingConfirmPanelLayout.createSequentialGroup()
                .addGap(105, 105, 105)
                .addGroup(homeBookingConfirmPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(homeBookingConfirmPanelLayout.createSequentialGroup()
                    ...
                    .addGroup(homeBookingConfirmPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(selectDateComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(homeBookingConfirmPanelLayout.createSequentialGroup()
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, homeBookingConfirmPanelLayout.createSequentialGroup()
                .addGroup(homeBookingConfirmPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(homeBookingConfirmPanelLayout.createSequentialGroup()
        ...
        homeBookingConfirmPanelLayout.setVerticalGroup(
            homeBookingConfirmPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(homeBookingConfirmPanelLayout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(logoutButton)
                .addGap(78, 78, 78)
                .addGroup(homeBookingConfirmPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(100, 100, 100)
                .addComponent(homeBookingConfirmPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(100, 100, 100))
        );
    ...
    // This method acts as a QR code generator
    // It creates a string of length 6, containing numbers and letters
    public String generateQRCode(int digits)
    {
        ...
        String qrCode = sb.toString().substring(0, digits);
        return qrCode;
    }
    ...
    private void confirmBookingButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBookingButtonActionPerformed
        ...
        if (newStartHour % 1 != 0)
        {
            ...
            if (newStartHour < OnlineBookingPage.FIRST_DOUBLE_DIGIT)
            {   
        ...
        try
        {
            generatedQRCode = generateQRCode(digits);
            Post bookingPost = bookingFactory.createPost();
            bookingPost.createPostRequest(customerId, selectedTestingSite.getId(), newStartTime, generatedQRCode, generatedUrl);
            String displayInfo = "Booking has been confirmed.\n" +
                    "Please remember the following details:" + "\n" +
                    "QR Code: " + generatedQRCode + "\n" +
                    "URL: " + generatedUrl;
            JOptionPane.showMessageDialog(null, displayInfo, "Booking Confirmation", JOptionPane.INFORMATION_MESSAGE);
        }
        catch (Exception e)
        {
    ...
    private javax.swing.JPanel homeBookingConfirmPanel;
